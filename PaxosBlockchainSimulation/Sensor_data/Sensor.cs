...
namespace PaxosBlockchainSimulation.Sensor_data
{
    // based on https://docs.microsoft.com/en-us/dotnet/api/system.io.ports.serialport?view=dotnet-plat-ext-5.0
    public class PortChat
    {
        ...
        public String Read()
        {
            ...
            {
                Write(" ");
                string message = name + ":" + _serialPort.ReadLine();
        ...
        public void Write(String message)
        {
            ...
            catch (TimeoutException) { Console.WriteLine("Failed writing"); }
        }
